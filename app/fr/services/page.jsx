...
export const metadata = { title: "Expertises — Nemsi Media", description: "Identité, sites web, e-commerce, UI/UX, applications et SEO réunis dans une approche digitale cohérente." }
